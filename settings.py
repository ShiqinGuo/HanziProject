...
SECRET_KEY = 'django-insecure-p9o8i-zjdhfuqiwerg9q3487hfq9wehgf934ht'
...
CACHES = {
    'default': {
        ...
        'LOCATION': 'hanzi-cache',
    }
}

# 如果需要使用 Redis 缓存，取消下面的注释并配置
# CACHES = {
#     'default': {
